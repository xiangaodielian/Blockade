...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 31133624;
    var PACKAGE_UUID = '84b9d550-2b43-4084-a14c-48c49ed8605b';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    new DataRequest(788916, 914352, 0, 0).open('GET', '/mainData');
    new DataRequest(914352, 916475, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(916475, 28134171, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(28134171, 28398535, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(28398535, 28402691, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(28402691, 28407903, 0, 0).open('GET', '/sharedassets10.assets');
    new DataRequest(28407903, 28413115, 0, 0).open('GET', '/sharedassets11.assets');
    new DataRequest(28413115, 28418327, 0, 0).open('GET', '/sharedassets12.assets');
    new DataRequest(28418327, 28423539, 0, 0).open('GET', '/sharedassets13.assets');
    new DataRequest(28423539, 28428751, 0, 0).open('GET', '/sharedassets14.assets');
    new DataRequest(28428751, 28433963, 0, 0).open('GET', '/sharedassets15.assets');
    new DataRequest(28433963, 28439175, 0, 0).open('GET', '/sharedassets16.assets');
    new DataRequest(28439175, 28444387, 0, 0).open('GET', '/sharedassets17.assets');
    new DataRequest(28444387, 28449599, 0, 0).open('GET', '/sharedassets18.assets');
    new DataRequest(28449599, 28454811, 0, 0).open('GET', '/sharedassets19.assets');
    new DataRequest(28454811, 28717511, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(28717511, 29002892, 0, 0).open('GET', '/sharedassets2.resource');
    new DataRequest(29002892, 29008104, 0, 0).open('GET', '/sharedassets20.assets');
    new DataRequest(29008104, 29013316, 0, 0).open('GET', '/sharedassets21.assets');
    new DataRequest(29013316, 29017472, 0, 0).open('GET', '/sharedassets22.assets');
    new DataRequest(29017472, 29021628, 0, 0).open('GET', '/sharedassets23.assets');
    new DataRequest(29021628, 29026840, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(29026840, 29032052, 0, 0).open('GET', '/sharedassets4.assets');
    new DataRequest(29032052, 29037264, 0, 0).open('GET', '/sharedassets5.assets');
    new DataRequest(29037264, 29042476, 0, 0).open('GET', '/sharedassets6.assets');
    new DataRequest(29042476, 29047688, 0, 0).open('GET', '/sharedassets7.assets');
    new DataRequest(29047688, 29052900, 0, 0).open('GET', '/sharedassets8.assets');
    new DataRequest(29052900, 29058112, 0, 0).open('GET', '/sharedassets9.assets');
    new DataRequest(29058112, 30633148, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(30633148, 31133624, 0, 0).open('GET', '/Resources/unity_builtin_extra');
